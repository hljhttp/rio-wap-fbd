...
function setupApp() {
    ...
    if (typeof ADAL!== 'undefined' && ADAL && window.cordova) {
        adalSignIn();
    } else {
...
function performLoadedAction(url)
{
    ...
    if (typeof ADAL!== 'undefined' && ADAL || typeof MSAL!== 'undefined' && MSAL || typeof hello_js_support!=='undefined' && hello_js_support && hello_js_support.isInitialized()) {
        executeAjaxRequestWithAdalLogic(ADAL!=null ? ADAL.config.clientId : MSAL!=null ? MSAL.clientId : hello_js_support.getClientId(), executeAjaxRequest, url, payload, {"event":event},onsuccess_loaded,onfailure_loaded,onfailure_loaded);
    } else {
    ...
    .then(function(form)
    {
        ...
        window.onresize = function(event)
        {
            ...
            var myevent =
            {
                ...
                "controlId": (typeof formObj !== 'undefined' && formObj && formObj.hasOwnProperty("_id") ? formObj._id : ""),
                "controlType": "form",
                "controlProperties": (typeof formObj !== 'undefined' && formObj && formObj.properties ? formObj.properties : null),
                "value": null
            };
    ...
    if (typeof ADAL!== 'undefined' && ADAL || typeof MSAL!== 'undefined' && MSAL || typeof hello_js_support!=='undefined' && hello_js_support && hello_js_support.isInitialized()) {
        if (waitCalculation) {
            TogFormViewer.queueEventAfterCalculation((function (url, myevent, sendForm, additionalConfig) {
                return function() {
                    var payload = {"appInfo" : TogFormViewer.getAppInfo(myevent,sendForm)};
                    executeAjaxRequestWithAdalLogic(ADAL!=null ? ADAL.config.clientId : MSAL!=null ? MSAL.clientId : hello_js_support.getClientId(), executeAjaxRequest, url, payload, additionalConfig,onsuccess_eventorcustomaction,onfailure_eventorcustomaction,onfailure_eventorcustomaction);
                };
