...
(function($)
{
    $.fn.translate = function()
    {
        return this.each(function()
        {
            ...
            } else if ($this.attr("lang-tran") !== undefined && langObj && langObj.i18n
            ...
            && langObj.i18n[languageSelector.selectedLanguage][$this.attr("lang-tran")] !== undefined)
            {
                ...
                $this.html(langObj.i18n[languageSelector.selectedLanguage][$this.attr("lang-tran")]);
            ...
            if (typeof langTopMenusObj === 'object' && langTopMenusObj != null && Object.keys(langTopMenusObj).length !== 0 && $this.attr("lang-tran-menu-top") !== undefined && langTopMenusObj.hasOwnProperty(languageSelector.selectedLanguage)
            ...
            if (typeof langLeftMenusObj === 'object' && langLeftMenusObj != null && Object.keys(langLeftMenusObj).length !== 0 && $this.attr("lang-tran-menu-left") !== undefined && langLeftMenusObj.hasOwnProperty(languageSelector.selectedLanguage)
            ...
            if (typeof langBottomMenusObj === 'object' && langBottomMenusObj != null && Object.keys(langBottomMenusObj).length !== 0 && $this.attr("lang-tran-menu-bottom") !== undefined && langBottomMenusObj.hasOwnProperty(languageSelector.selectedLanguage)
...
function setChosenLanguage()
{
    ...
    // if language is changed and we use MSAL for non-AAD (B2C) scenario, or we use hello.js, user info should be updated (language specifiec links to edit/reset policies and change MSAL/hello.js postLogoutRedirectUri)
    if (languageChanged && (MSAL!=null && !isAAD() || hello_js_support!=null && hello_js_support.isInitialized())) {
        fillUserInfo(true);
    }
    applyTranslation();
    MapPlugIn.reloadMap();
