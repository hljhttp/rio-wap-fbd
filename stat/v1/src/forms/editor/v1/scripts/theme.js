...
themesMap['ebh'] =
{
    ...
    mapStyle: {
        "elements": {
            "water": { "fillColor": "#46bcec" },
            "waterPoint": { "iconColor": "#a1e0ff" },
            "transportation": { "strokeColor": "#bdbdbd" },
            "road": { "fillColor": "#eeeeee" },
            "adminDistrict": { "borderStrokeColor": "transparent", "borderOutlineColor": "transparent" },
            "countryRegion": { "borderStrokeColor": "#dadada", "borderOutlineColor": "#e0dfdf" },
            "political": { "borderStrokeColor": "#dadada", "borderOutlineColor": "#e0dfdf" },
            "railway": { "strokeColor": "#a495b2" },
            "structure": { "fillColor": "#ffffff" },
            "runway": { "fillColor": "#ff7fed" },
            "area": { "fillColor": "#f8f8f8" },
            "point": { "iconColor": "#ffffff", "fillColor": "#FF6FA0", "strokeColor": "#DB4680" },
            "transit": { "fillColor": "#bdbdbd" }
        },
        "version": "1.0" 
    }
};
...
function applyTheme()
{
    ...
    console.log(document.getElementById('bodystyle'))
