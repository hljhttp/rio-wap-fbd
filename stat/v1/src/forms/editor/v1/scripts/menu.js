...
//                 if (typeof langTopMenusObj === 'object' && langTopMenusObj != null && Object.keys(langTopMenusObj).length !== 0 && langTopMenusObj[languageSelector.currentLanguage] && langTopMenusObj[languageSelector.currentLanguage].hasOwnProperty(propName))
//                 {
...
//             if (typeof langLeftMenusObj === 'object' && langLeftMenusObj != null && Object.keys(langLeftMenusObj).length !== 0 && langLeftMenusObj[languageSelector.currentLanguage] && langLeftMenusObj[languageSelector.currentLanguage].hasOwnProperty(propName))
//             {
...
//     if (typeof menusObj !== 'undefined' && menusObj != null && typeof menusObj === 'object' && menusObj != null && Object.keys(menusObj).length !== 0 && typeof langTopMenusObj === 'object' && langTopMenusObj != null && Object.keys(langTopMenusObj).length !== 0) 
//     {
//         loadMenus(update);
//     }
// }
...
//             // Use propName if we don't have translation for current language
//             if (typeof langLeftMenusObj === 'object' && langLeftMenusObj != null && Object.keys(langLeftMenusObj).length !== 0
...
//             if (typeof langBottomMenusObj === 'object' && langBottomMenusObj != null && Object.keys(langBottomMenusObj).length !== 0 && langBottomMenusObj[languageSelector.currentLanguage] && langBottomMenusObj[languageSelector.currentLanguage].hasOwnProperty(propName)) 
//             {
...
//             if (typeof langBottomMenusObj === 'object' && langBottomMenusObj != null && Object.keys(langBottomMenusObj).length !== 0 && langBottomMenusObj[languageSelector.currentLanguage] && langBottomMenusObj[languageSelector.currentLanguage].hasOwnProperty(primaryTab)) 
//             {
